...
using Constants = _14.Common.Constants;

namespace _14.Replier
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            consumer.Received += (sender, e) =>
            {
                ...
                basicProperties.Headers.Add(Common.Constants.RequestIdHeaderKey, e.BasicProperties.Headers[Constants.RequestIdHeaderKey]);
